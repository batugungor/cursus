...
return [
    ...
    'providers' => [
        ...
        App\Providers\RegisterCustomFieldsProvider::class,
        App\Providers\RegisterCustomBlocksProvider::class,
        App\Providers\RegisterStudentEnrollmentProvider::class,
        App\Providers\RegisterPostRowActionsProvider::class,
        App\Providers\RegisterCustomMetaProvider::class,
    ],
